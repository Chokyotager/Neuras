...
//var l21 = new neuras.Layer('input').addNeurones(3, 'sin');
...
var l3 = new neuras.Layer('hidden').addNeurones(2, 'tanh');//.addGates(12, 'spike', {threshold: Math.random() * 10, iterative: 0.92});

l1.connect(l3);
//l2.connect(ll);
//ll.connect(l4);

var linkage = new neuras.Linkage([l1, l3]);
...
for (var i = 0; i < 100; i++) {
  var loss = mentor.train([2, 2], [0.6, 0.6], 0.004);
