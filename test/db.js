...
var l = new neuras.Layer().addNeurones(4, 'identity');
var l2 = new neuras.Layer().addNeurones(4, 'logistic');
...
var trainsets = [[1, 1, 1, 0], [0, 0, 0, 1], [1, 0, 1, 0]];
